...
ADD https://www.terraria.org/system/dedicated_servers/archives/000/000/039/original/terraria-server-1405.zip /terraria.zip
...
COPY --from=base /1405/Linux/* /TerrariaServer/
